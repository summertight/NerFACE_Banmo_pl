...
class kakao_deca_Dataset(Dataset):
    def __init__(self, basedir, mode='train', img_size=[256, 256], trans_set_0=False):
        super().__init__()
        basedir = '/data/public/rw/workspace-malfo/kmu-mag'##XXX This is fixed for beta-test#194
        ...
        #fov = 12
        with open(os.path.join(basedir, "data.json"), "r") as fp:
        ...
        #import pdb;pdb.set_trace()
        self.image_list = sorted(glob.glob(os.path.join(self.basedir,'/images/*.jpg')))
...
if __name__ == "__main__":
    ...
    dataset = kakao_deca_Dataset(basedir=basedir, mode='train')
