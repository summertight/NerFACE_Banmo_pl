...
class Frame_3dmm_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #angle[0] = -angle[0]#XXX aligning distribution.
        
        if self.trans_set_0:
            trans = np.zeros_like(trans)

        pose = rotvec_to_rotmatrix(angle, trans).astype(np.float32)
...
if __name__ == "__main__":
    ...
    dataset = Frame_3dmm_Dataset(basedir=basedir, mode='train')
