...
from runners.run_utils_banmo import NerFACE
...
class RunnerNerface_banmo(pl.LightningModule):
    ...
    def __init__(self, cfg, model_pack, start_epoch):
        ...
        self.latent_codes_G = model_pack['latent_codes_G'] 
        
        self.model_D2C = model_pack['model_O2C'] 
        self.model_C2O = model_pack['model_C2O']  
    ...
    def training_step(self, batch, batch_idx):
        ...
        GT, pose, expression, data_idx \
            = batch['image'].squeeze(), batch['pose'].squeeze(), batch['expression'].squeeze(), batch['data_idx']
        ...
        latent_code_G = self.latent_codes_G[data_idx].to(device)
        ...
        rgb_coarse ,rgb_fine, _ = \
            NerFACE(self.model_coarse, self.model_fine, self.model_D2C, self.model_C2O,
                                 ...
                                 expressions = expression, background_prior=bg_color_sampled, 
                                 latent_code = latent_code, latent_code_G = latent_code_G)
