...
from runners.run_utils_DNerf_pervideo import NerFACE
...
class RunnerNerface_DNerf_pervideo(pl.LightningModule):
    ...
    def __init__(self, cfg, model_pack, start_epoch):
        ...
        self.latent_codes_E_share = model_pack['latent_codes_E_share']
    ...
    def training_step(self, batch, batch_idx):
        ...
        latent_code_E_share = self.latent_codes_E_share[video_label].to(device)
        ...
        rgb_coarse ,rgb_fine, _ = \
            NerFACE(self.model_coarse, self.model_fine, self.model_O2C,
                                 ...
                                 expressions = expression, background_prior=None, latent_code_E_share = latent_code_E_share)
        ...
        loss['total'] = loss['coarse'] + loss['fine'] + loss['latent_code_E']
    ...
    def configure_optimizers(self):
        ...
        trainable_list.append(self.latent_codes_E_share)
